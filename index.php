...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">HERMAN JAYADI</a>
...
<body>
  ...
  <img src="img/POTOHER.jpg" alt="" width="300" height="300">
  <span>
  <h2 class="1">Nama: Herman jayadi</h2>
  <h2>          Nim: TI19220014</h2>
  <h2>          Jurusan: Teknik Informatika</h2>
  <h2>          Alamat: Jongkor</h2>
  <span>
    <br>

  <h3> MOTIVASI DIRI UNTUK DIRI SENDIRI </h3>

     <h3> "Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle." </h3>
     <br>

     <h3> "Percayalah pada dirimu dan semua yang ada padamu. Ketahuilah bahwa ada sesuatu di dalam dirimu yang lebih besar daripada segala rintangan." </h3>
   <br>
</body>
</html>

                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa STMIK </h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
